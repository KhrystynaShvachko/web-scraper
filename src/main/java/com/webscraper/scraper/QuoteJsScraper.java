...
public class QuoteJsScraper {
    ...
    public QuoteJsScraper(HttpClientService httpClientService, QuoteJsPageParser parser) {
    ...
    public void scrape() {
        ...
        try {
            ...
            while (url != null) {
                ...
                quotes.addAll(parser.parse(document));
            ...
            System.out.println("Writing output/quotes-js.json...");

            JsonWriter.writeToFile("output/quotes-js.json", quotes);

        } catch (Exception e) {

            System.err.println("JS scraper failed");
